...
| F-new-6 | "Similar items" section trong Item Detail khi hết slot / đã đóng (A-13) | _unassigned_ | [x] | app [a90d00b](https://github.com/thanks-org/thanks-app/commit/a90d00b) — done as part of F6-8 |
| F-new-7 | Re-post gợi ý sau khi item hết hạn — My Items + notification tap (K-15) | _unassigned_ | [x] | app [a90d00b](https://github.com/thanks-org/thanks-app/commit/a90d00b) — "Đăng lại" button on completed/cancelled items |
...
| F6-8 | "Similar items" carousel khi item hết hàng — Item Detail show 3-5 cards từ `GET /posts/:id/similar` | _unassigned_ | [x] | Journey 11. app [a90d00b](https://github.com/thanks-org/thanks-app/commit/a90d00b) |
| F6-9 | Re-post suggestion — My Items Personal (F2-4) item đã expires hiện CTA "Đăng lại" với prefilled draft | _unassigned_ | [x] | Journey 10. app [a90d00b](https://github.com/thanks-org/thanks-app/commit/a90d00b) |
...
| F7-2 | **Rating Composer Screen** — sau pickup completed, full-screen rating (1–5 sao + text) cho cả 2 phía | _unassigned_ | [x] | app [62c4051](https://github.com/thanks-org/thanks-app/commit/62c4051) — RatingComposerScreen full-screen, AnimatedSwitcher stars, replaces dialog in Messages |
...
| F7-6 | **Edit Post screen / Re-post from expired** — full edit form (mở rộng từ F6-9 CTA) prefilled từ post cũ → `PUT /posts/:id` hoặc `POST /posts` với draft | _unassigned_ | [x] | app [62c4051](https://github.com/thanks-org/thanks-app/commit/62c4051) — EditPostScreen (title/desc/category/images), "···" bottom sheet in My Items |
...
| F7-8 | **Org Dashboard screen** — list claims do tất cả members trong org đã claim, filter status, group by member | _unassigned_ | [x] | app [62c4051](https://github.com/thanks-org/thanks-app/commit/62c4051) — OrgDashboardScreen, OrgClaimEntry model, OrganizationService.listOrgClaims |
